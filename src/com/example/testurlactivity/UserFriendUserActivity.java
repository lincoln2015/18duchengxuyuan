...
import com.example.testurlactivity.UserFansActivity.urlThreadGetImg;
...
public class UserFriendUserActivity extends Activity {
		...
		public void run() {
			try {
				...
				HttpClient client = new DefaultHttpClient();
				 ...
				 HttpGet httpGet = new HttpGet(URLHelper.SERVER_URl + "/test/ajax/get_friend_users/?user_id="+userID);
