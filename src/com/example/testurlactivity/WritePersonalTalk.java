...
import com.example.testurlactivity.UserDetailEditActivity.ApacheHttpThreadUpdateProfileSetting;
...
public class WritePersonalTalk extends Activity {
		         ...
		         if (msg.what == 0x18)
		         {
	                 	...
	                 	mListView.setOnItemClickListener(new OnItemClickListener(){
							 	...
							 	public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,long arg3) {
							 		...
							 		Intent intent = new Intent(getApplicationContext(),	PersonalTalkWriteMessage.class);
				 		
							 		intent.putExtra("user_id",String.valueOf(mUserAdapter.getItem(arg2).getUserId()));
